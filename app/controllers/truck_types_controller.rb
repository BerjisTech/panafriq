...
class TruckTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @truck_type.save
        format.html { redirect_to truck_type_url(@truck_type), notice: 'Truck type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @truck_type.update(truck_type_params)
        format.html { redirect_to truck_type_url(@truck_type), notice: 'Truck type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to truck_types_url, notice: 'Truck type was successfully destroyed.' }
