  ...
  def create
    ...
    respond_to do |format|
      if @company_location.save
        format.html { redirect_to company_location_url(@company_location), notice: "Company location was successfully created." }
  ...
  def update
    respond_to do |format|
      if @company_location.update(company_location_params)
        format.html { redirect_to company_location_url(@company_location), notice: "Company location was successfully updated." }
