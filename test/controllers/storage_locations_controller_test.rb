...
class StorageLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create storage_location' do
    assert_difference('StorageLocation.count') do
      post storage_locations_url,
           params: { storage_location: { name: @storage_location.name, products: @storage_location.products,
                                         services: @storage_location.services, storage_id: @storage_location.storage_id, storage_price: @storage_location.storage_price, storage_size: @storage_location.storage_size, storage_type: @storage_location.storage_type, user_id: @storage_location.user_id } }
    end
  ...
  test 'should update storage_location' do
    patch storage_location_url(@storage_location),
          params: { storage_location: { name: @storage_location.name, products: @storage_location.products,
                                        services: @storage_location.services, storage_id: @storage_location.storage_id, storage_price: @storage_location.storage_price, storage_size: @storage_location.storage_size, storage_type: @storage_location.storage_type, user_id: @storage_location.user_id } }
