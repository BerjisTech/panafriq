...
class CompanyLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create company_location' do
    assert_difference('CompanyLocation.count') do
      post company_locations_url,
           params: { company_location: { company_id: @company_location.company_id, name: @company_location.name,
                                         products: @company_location.products, services: @company_location.services, user_id: @company_location.user_id } }
    end
  ...
  test 'should update company_location' do
    patch company_location_url(@company_location),
          params: { company_location: { company_id: @company_location.company_id, name: @company_location.name,
                                        products: @company_location.products, services: @company_location.services, user_id: @company_location.user_id } }
